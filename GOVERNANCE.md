...
Paperless Sync is an independent, community-oriented open source project maintained by Dennis Otto.

## Decisions

Feature, compatibility, and maintenance decisions are discussed in public GitHub issues and pull requests whenever they do not contain security-sensitive information. Decisions prioritize data safety, secure defaults, compatibility with supported Nextcloud releases, backward compatibility, maintainability, and the needs of users running their own infrastructure.
